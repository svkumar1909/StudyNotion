...
import { buyCourse } from "../services/operations/studentFeaturesAPI"  // Updated import
...
function CourseDetails() {
  ...
  const handleBuyCourse = () => {
    if (token) {
      buyCourse(token, [courseId], user, navigate, dispatch)  // Updated function call
      return
    }
          ...
          <div className="max-w-[830px] ">
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-3 py-5">
                <div className="h-[90px] w-[90px] rounded-full bg-richblack-100">
                  <img
                ...
                <div>
                  ...
                  <p className="text-richblack-400">{instructor.bio}</p>
                </div>
              </div>
            </div>
          </div>
